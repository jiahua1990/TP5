            ...
            'points' => [
                ...
                'values' => [
                    ...
                    'describe' => "a) 积分不可兑现、不可转让,仅可在本平台使用;\n" .
                        "b) 积分抵扣和优惠券不能同时使用;".
                        "c) 您在本平台参加特定活动也可使用积分,详细使用规则以具体活动时的规则为准;\n" .
                        "d) 积分的数值精确到个位(小数点后全部舍弃,不进行四舍五入)\n" .
                        "e) 买家在完成该笔交易(订单状态为“已签收”)后才能得到此笔交易的相应积分,如购买商品参加店铺其他优惠,则优惠的金额部分不享受积分获取;",
                    'sign_in' => [     // 积分签到
                        'is_open' => '0',                   // 是否开启签到
                        'basic_sign_point' => '1',          // 签到赠送
                        'first_sign_point' => '0',          // 首次签到额外奖励
                        'bonus_sign_point' => [],          // 连续签到额外奖励
                    ],
                    'dealer' => [     // 分销商积分兑换余额
                        'is_open' => '0',                   // 是否开启兑换
                        'exchange_ratio' => '0.01',          // 积分兑换比例
                    ],
                ],
            ],
        ];
