...
class User extends BaseModel
{
    ...
    {   
        return $this->hasMany('app\store\model\dealer\Referee','dealer_id','user_id');
    }
    ...
    {
        return self::get($user_id, ['user', 'referee', 'level_user'=>function($query){
                $query->alias("referee")
