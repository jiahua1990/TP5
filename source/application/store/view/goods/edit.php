                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <!-- 商品多规格 -->
                            <div id="many-app" v-cloak class="goods-spec-many am-form-group" v-bind:style="{display: '<?= $model['spec_type'] == 20 ? 'block' : 'none' ?>'}">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    ...
                                    <div class="help-block">
                                        <small>注：需在【营销管理--积分管理--积分设置】中设置开启积分赠送</small>
                                    </div>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    ...
                                    <div class="help-block">
                                        <small>注：需在【营销管理--积分管理--积分设置】中设置允许积分抵扣</small>
                                    </div>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <div class="am-input-group am-form-group am-margin-top-sm">
                                        ...
                                        <input type="number" class="am-form-field" min="0" max="100"
                                               name="goods[points_discount_ratio]"
                                               value="<?= $model['points_discount_ratio'] ?>" required>
                                        <span class="am-input-group-label am-input-group-label__right">%</span>
                                    </div>
                                    <div class="help-block">
                                        <small>注：范围0~100,例如金额100元，可抵扣10%，此时用户可抵扣10元</small>
                                    </div>
                                </div>
                            </div>
