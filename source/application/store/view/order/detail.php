                        ...
                        <?php if ($detail['delivery_status']['value'] == 10): ?>
                            <?php if (checkPrivilege('order/delivery')): ?>
                                ...
                                <form id="delivery" class="my-form am-form tpl-form-line-form" method="post"
                                    ...
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">物流信息 </label>
                                        <div class="am-u-sm-9 am-u-end">
                                            <div class="am-u-sm-9">
                                                <label class="am-radio-inline">
                                                    <input type="radio" name="order[express_single]"
                                                           value="1"
                                                           data-am-ucheck
                                                           checked required>
                                                    单个
                                    ...
                                    <div class="am-form-group item-agree-0 form-tab-group">
                                        <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">配送商品 </label>
                                        <div class="am-u-sm-9 am-u-end">
                                            <input type="text" class="tpl-form-input" name="order[express_goods]" required>
                                        </div>
                                    </div>
                                    <div class="am-form-group item-agree-0 form-tab-group" id="many-app"  v-cloak>
                                        <div class="am-u-sm-9 am-u-sm-push-2 am-margin-top-lg">
                                            <button type="button" class="j-submit am-btn am-btn-sm am-btn-secondary"  @click="addExpress()">添加</button>
                                        </div>
                                        <div class="goods-spec-box am-u-sm-9 am-u-sm-push-2 am-u-end">
                                            <div class="goods-sku am-scrollable-horizontal">
                                                ...
                                                <table class="spec-sku-tabel am-table am-table-bordered am-table-centered am-margin-bottom-xs am-text-nowrap">
                                                    ...
                                                    <tr v-for="(item, index) in extra_express">
                                                        <td>
                                                            <select :name="'order[express]['+index+'][express_id]'"
                                                                    data-am-selected="{btnSize: 'sm', maxHeight: 240}"
                                                                    v-model="item.express_id" required>
                                                                <option value=""></option>
                                                                <?php if (isset($expressList)): foreach ($expressList as $expres): ?>
                                                                    <option value="<?= $expres['express_id'] ?>">
                                                                        <?= $expres['express_name'] ?>
                                                        ...
                                                        <td>
                                                            <input type="text" class="ipt-w80" :name="'order[express]['+index+'][express_no]'"
                                                            v-model="item.express_no" required>
                                                        </td>
                                                        <td>
                                                            <input type="text" class="ipt-w80" :name="'order[express]['+index+'][express_goods]'"
                                                            v-model="item.express_goods" required>
                                                        </td>
                                                        <td>
                                                            <div class="tpl-table-black-operation">
                                                                <a class="item-delete tpl-table-black-operation-del" @click="deleteExpress(index)">
                            ...
                            <div class="am-scrollable-horizontal">
                                <table class="regional-table am-table am-table-bordered am-table-centered
                                    ...
                                    <tr>
                                        <th>物流公司</th>
                                        <th>物流单号</th>
                                        <?php if ($detail['express_single'] == 0): ?><th>配送商品</th><?php endif; ?>
                                        <th>发货状态</th>
                                        <th>发货时间</th>
                                    </tr>
                                    <tr>
                                        ...
                                        <?php if ($detail['express_single'] == 0): ?><td><?= $detail['express_goods'] ?></td><?php endif; ?>
                                        <td>
                                             <span class="am-badge
                                            <?= $detail['delivery_status']['value'] == 20 ? 'am-badge-success' : '' ?>">
                                                    <?= $detail['delivery_status']['text'] ?></span>
                                    ...
                                    <?php foreach ($detail['extra_express'] as $extra_express): ?>
                                    <tr>
                                        <td><?= $extra_express['express']['express_name'] ?></td>
                                        <td><?= $extra_express['express_no'] ?></td>
                                        <td><?= $extra_express['express_goods'] ?></td>
                                        <td>
                                             <span class="am-badge
                                            <?= $detail['delivery_status']['value'] == 20 ? 'am-badge-success' : '' ?>">
                                                    <?= $detail['delivery_status']['text'] ?></span>
...
<script src="assets/store/js/extra.express.js?v=<?= $version ?>"></script>
<script>
    $(function () {
    });
</script>
...
<script>
    $(function () {
        ...
        // 注册酒店商品组件
        var extra = new ExtraExpress({
            el: '#many-app',
        });

        // 切换物流信息单个还是多个
        $("input:radio[name='order[express_single]']").change(function (e) {
            $('.form-tab-group')
                .removeClass('active')
        ...
        $('.my-form').superForm({
            // 自定义验证
            validation: function () {
                var checked = $("input:radio[name='order[express_single]']:checked").val();
                console.log(checked);
                var isEmpty = extra.appVue.isEmptyExpress();
                (isEmpty === true && checked == 0) && layer.msg('请添加物流订单');
                return !(isEmpty === true && checked == 0);
            }
        });
