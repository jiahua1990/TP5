                            ...
                            <div class="am-tabs-bd">
                                ...
                                <div class="am-tab-panel am-margin-top-lg" id="tab9">
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="number" min="0" max="10" class="tpl-form-input"
                                                   name="setting[group_commission][zhixia_zhuren_proportion]"
                                                   value="<?= $data['group_commission']['values']['zhixia_zhuren_proportion'] ?>" required>
                                            <small>奖金比例范围 0% - 10%</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="number" min="0" max="10" class="tpl-form-input"
                                                   name="setting[group_commission][zhixia_jingli_proportion]"
                                                   value="<?= $data['group_commission']['values']['zhixia_jingli_proportion'] ?>" required>
                                            <small>奖金比例范围 0% - 10%</small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="number" min="0" max="10" class="tpl-form-input"
                                                   name="setting[group_commission][yucheng_jingli_proportion]"
                                                   value="<?= $data['group_commission']['values']['yucheng_jingli_proportion'] ?>"
                                                   required>
                                            <small>奖金比例范围 0% - 10%</small>
                                        </div>
                                    </div>
                                     ...
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="number" min="0" max="10" class="tpl-form-input"
                                                   name="setting[group_commission][zhixia_zongjian_proportion]"
                                                   value="<?= $data['group_commission']['values']['zhixia_zongjian_proportion'] ?>" required>
                                            <small>奖金比例范围 0% - 10%</small>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="number" min="0" max="10" class="tpl-form-input"
                                                   name="setting[group_commission][yucheng_zongjian_proportion]"
                                                   value="<?= $data['group_commission']['values']['yucheng_zongjian_proportion'] ?>"
                                                   required>
                                            <small>奖金比例范围 0% - 10%</small>
                                        </div>
                                    </div>
                                     ...
                                     <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="number" min="0"  step="500" class="tpl-form-input"
                                                   name="setting[group_commission][zhuren_yuedu_money]"
                                                   value="<?= $data['group_commission']['values']['zhuren_yuedu_money'] ?>"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="number" min="0"  step="500" class="tpl-form-input"
                                                   name="setting[group_commission][jingli_yuedu_money]"
                                                   value="<?= $data['group_commission']['values']['jingli_yuedu_money'] ?>"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="number" min="0"  step="500" class="tpl-form-input"
                                                   name="setting[group_commission][zongjian_yuedu_money]"
                                                   value="<?= $data['group_commission']['values']['zongjian_yuedu_money'] ?>"
                                                   required>
                                        </div>
                                    </div>
                                 
                                 
                                    <div class="help-block" style="margin-left: 30rem">
                                        <small>例: 直辖团队奖金 = 直辖团队销售额 * 奖金比例  </small>
                                    </div>
                                </div>
                            </div>
                        </div>
