                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                        <?php
                                            ...
                                            $second_num = 0;
                                            $third_num = 0;
                                            foreach ($item['level_user'] as $level_user) {
                                                if($level_user['level'] == 1) $first_num += 1;
                                                elseif($level_user['level'] == 2) $second_num += 1;
                                                elseif($level_user['level'] == 3) $third_num += 1;
                                            }
                                        ?>
                                        <p>
                                            <a href="<?= url('apps.dealer.user/fans', ['user_id' => $item['user_id'], 'level' => 1]) ?>"
                                               target="_blank">一级：<?= $first_num ?></a>
                                        </p>
